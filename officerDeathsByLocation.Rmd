...
This actually happened a lot, so you can't really trust all the zeroes. But surely some of the zeroes are accurate -- it's possible for a small-town department to have zero officer deaths. To not include them at all would also be a mistake. But I think including all the mistaken zeroes ended up being a bigger mistake overall.

So here's the same plot with the zeroes removed.
